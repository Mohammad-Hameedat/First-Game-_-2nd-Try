...
public class HungryMovementStrategy : IMovementStrategy
{
    ...
    public HungryMovementStrategy(MovementController _movementController, TargetingSystem _targetingSystem)
    {
    ...
    /* This is the older version of the Move method
    public void Move(Rigidbody rb)
    {
        Transform target = targetingSystem.GetNearestObject();
